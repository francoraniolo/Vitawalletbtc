...
ActiveRecord::Schema[7.1].define(version: 2024_02_19_163334) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.decimal "usd_balance", precision: 10, scale: 2, default: "1000000.0"
    t.decimal "btc_balance", precision: 16, scale: 8
